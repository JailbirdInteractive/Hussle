...
<form method="POST" action="/users/{{$user->id}}" id="updateform" name="updateform">
@method('PATCH')
    @csrf
							<div class="row">
									...
									<div class="row">
										...
										<div class="col-xl-6">
											<div class="submit-field">
												<h5>Name</h5>
												<input type="text" class="with-border" value={{{ isset(Auth::user()->name) ? Auth::user()->name : Auth::user()->email }}}>
											</div>
										</div>
										...
										<div class="col-xl-6">
											...
											<div class="submit-field">
												...
												<div class="account-type">
													...
													<div>
														<input type="radio" name="account_type" id="employer-radio" class="account-type-radio"/>
												...
												<div class="account-type">
														...
														<div>
															<input type="radio" name="account_type" id="freelancer-radio" class="account-type-radio" />
															<label for="freelancer-radio" class="ripple-effect-dark"><i class="icon-material-outline-account-circle"></i> Freelancer</label>
														</div>
